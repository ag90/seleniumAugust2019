...
public class Xpath {
  ...
  public void f() throws InterruptedException {
	...
	//starts-with
	 ...
	 //dynamic using pipe symbol(|)
	 driver.findElement(By.xpath("//a[contains(text(),'Agile')] | //a[contains(text(),'SDET')]")).click();
	 
	 driver.findElement(By.xpath("//input[@name='ui'] | //input[@type='text']")).sendKeys("Guru99.com");
	
	// driver.findElement(By.name("name | uid")).sendKeys("avi.g"); Cannot use like this.
